...
# Display results
num_methods = len(interpolation_results)
fig, axes = plt.subplots(3, num_methods + 1, figsize=(20, 12))
...
fig, axes = plt.subplots(2, num_methods + 1, figsize=(18, 10))
